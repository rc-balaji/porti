const portfolioData = {
  personal_info: {
    ...
    profile_picture: "/assets/images/my-profile.jpg",
    social_links: {
  ...
  services: [
    {
      ...
      description:
        "Creating responsive, interactive web applications with modern JavaScript frameworks like React and Vue.",
      icon: "code",
    },
    {
    ...
    },
    {
      ...
      description:
        "Designing and developing RESTful APIs and GraphQL services for seamless client-server communication.",
      icon: "api",
    },
    {
      name: "UI/UX Design",
      description:
        "Creating intuitive and aesthetically pleasing user interfaces with a focus on user experience.",
      icon: "layout",
    },
  ],
  ...
  projects: [
    {
      ...
      challenges:
        "Implementing a secure payment system and optimizing database queries for large product catalogs were the main challenges. Used caching strategies and database indexing to improve performance.",
    ...
    },
    {
      ...
      description:
        "A collaborative task management application with real-time updates, team workspace, and progress tracking.",
      detailed_description:
      ...
      challenges:
        "Implementing real-time updates across all connected clients was challenging. Used Firebase for real-time synchronization and notifications to ensure all team members received updates instantly.",
    ...
    },
    {
      ...
      challenges:
        "Integrating multiple weather APIs with different data formats and ensuring reliability when one API fails were significant challenges. Implemented a fallback system that automatically switches to alternative data sources when needed.",
    ...
    },
    {
      ...
      challenges:
        "Creating an effective search algorithm that balanced speed and accuracy while handling complex filtering options was challenging. Used MongoDB's geospatial indexing and developed a custom relevance scoring system.",
  ...
  experience: [
    {
      ...
      description:
        "Leading development of enterprise React applications, implementing modern UI patterns, and mentoring junior developers.",
    },
    {
      ...
      duration: "2018 - 2021",
      description:
        "Built scalable web applications using React, Node.js, and MongoDB. Implemented authentication systems and RESTful APIs.",
    },
    {
      ...
      duration: "2017 - 2018",
      description:
        "Developed responsive websites and assisted in building client-side applications using JavaScript and jQuery.",
    },
  ],
  ...
  achievements: [
    {
      ...
      year: 2022,
      description:
        "Received recognition for developing an innovative accessibility-focused web application.",
    },
    {
      title: "Hackathon Winner",
      year: 2020,
      description:
        "Won first place in a 48-hour hackathon for creating a community assistance platform.",
    },
  ],
  ...
  testimonials: [
    {
      ...
      quote:
        "Balaji is an exceptional developer who consistently delivers high-quality code and innovative solutions to complex problems.",
    ...
    },
    {
      ...
      quote:
        "Working with Balaji was a great experience. His technical expertise and dedication to meeting project goals made him an invaluable team member.",
      avatar: "/assets/images/profile.svg",
    },
    {
      name: "Michael Chen",
      ...
      quote:
        "Balaji's ability to quickly understand requirements and translate them into functional features is remarkable. Highly recommended!",
      avatar: "/assets/images/profile.svg",
    },
  ],
  ...
  awards: [
    {
      ...
      year: 2023,
      description:
        "Recognized for contributions to open-source projects and technical leadership.",
    },
    {
      name: "Innovation Excellence",
      year: 2021,
      description:
        "Awarded for developing a novel approach to real-time data visualization.",
    },
  ],
